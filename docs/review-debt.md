...
|---|---|---|---|
| unassigned | PolicyDrift | root | 4 |
| unassigned | Regression | root | 4 |
| security | PathPolicy | src/auth | 3 |
| security | Security | src/auth | 2 |
| unassigned | Security | .github/workflows | 2 |
| unassigned | Security | src/payments | 2 |
| unassigned | PathPolicy | src/payments | 2 |
| unassigned | Security | src/auth | 2 |
| platform | Engineering | src/auth | 1 |
| product | Design | src/auth | 1 |
| unassigned | Engineering | .github/workflows | 1 |
| unassigned | Engineering | src/payments | 1 |
| unassigned | Design | src/payments | 1 |
| unassigned | Engineering | src/auth | 1 |
| unassigned | Design | src/auth | 1 |

## Oldest Open Debt

| PR | Owner | Lens | Path Group | Age (days) | Finding |
|---|---|---|---|---|---|
| #102 | unassigned | Engineering | .github/workflows | 0 | No test file changes detected. |
...
| #101 | unassigned | Security | src/payments | 0 | Sensitive changes detected without test updates. |
| #101 | unassigned | PathPolicy | src/payments | 0 | Rule 'payments' matched 1 file(s); penalties applied (eng:8, product:0, design:0, sec:12). |
| #101 | unassigned | PathPolicy | src/payments | 0 | Rule 'payments': Payments changes must include tests. |
| #101 | unassigned | Regression | root | 0 | Regression signature '1b9a2adb321131e2' has appeared 4 times (including this run). |
